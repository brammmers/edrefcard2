...
hotasDetails = {
    ...
    '044FB68F': { # TM TPR Rudder
        # Although the individual pedals are analogue, they often have digital binds due to their nature so we pretend they are digital
        'Joy_XAxis': {'Type': 'Digital', 'x': 164, 'y': 591, 'width': 1332, 'height': 162}, # Left pedal
...
# Based on ANSI 104 from https://www.keyboard-layout-editor.com/
keyboardLayout = [
    ...
    [{'w':1.75},'Caps Lock','A','S','D','F','G','H','J','K','L',':\n;','\'\n"',{'w':2.25},'Enter__R',{'x':3.5},'4\n←','5','6\n→'],
    [{'w':2.25},'Shift__L','Z','X','C','V','B','N','M','<\n,','>\n.','?\n/',{'w':2.75},'Shift__R',{'x':1.25},'↑',{'x':1.25},'1\nEnd','2\n↓','3\nPgDn',{'h':2},'Enter__N'],
...
buttonMap = {
    ...
    'Pause\nBreak': ['Key_Pause','Key_Break'],
    '~\n`': ['Key_Grave','Key_Tilde'],
    '!\n1': ['Key_1','Key_Exclamation'],
    '@\n2': ['Key_2','Key_At'],
    '#\n3': ['Key_3','Key_Hash'],
    '$\n4': ['Key_4','Key_Dollar'],
    '%\n5': ['Key_5','Key_Percent'],
    '^\n6': ['Key_6','Key_Caret'],
    '&\n7': ['Key_7','Key_Ampersand'],
    '*\n8': ['Key_8','Key_Asterisk'],
    '(\n9': ['Key_9','Key_LeftParenthesis'],
    ')\n0': ['Key_0','Key_RightParenthesis'],
    ...
    'O': ['Key_O'],
    'P': ['Key_P'],
    '{\n[': ['Key_LeftBracket','Key_LeftBrace'],
    '}\n]': ['Key_RightBracket','Key_RightBrace'],
    '|\n\\': ['Key_BackSlash','Key_Pipe'],
    'Delete': ['Key_Delete'],
    'End': ['Key_End'],
    'PgDn': ['Key_PageDown'],
    '7\nHome': ['Key_Numpad_7','Key_Numpad_Home'],
    '8\n↑': ['Key_Numpad_8','Key_Numpad_UpArrow'],
    '9\nPgUp': ['Key_Numpad_9','Key_Numpad_PageUp'],
    '+': ['Key_Numpad_Add'],
    ...
    'Enter__R': ['Key_Enter'],
    '4\n←': ['Key_Numpad_4','Key_Numpad_LeftArrow'],
    '5': ['Key_Numpad_5'],
    '6\n→': ['Key_Numpad_6','Key_Numpad_RightArrow'],
    'Shift__L': ['Key_LeftShift'],
    'Z': ['Key_Z'],
    'X': ['Key_X'],
    'C': ['Key_C'],
    'V': ['Key_V'],
    ...
    'N': ['Key_N'],
    'M': ['Key_M'],
    '<\n,': ['Key_Comma','Key_LessThan'],
    '>\n.': ['Key_Period','Key_GreaterThan'],
    '?\n/': ['Key_Slash','Key_QuestionMark'],
    'Shift__R': ['Key_RightShift'],
    '↑': ['Key_UpArrow'],
    '1\nEnd': ['Key_Numpad_1','Key_Numpad_End'],
    '2\n↓': ['Key_Numpad_2','Key_Numpad_DownArrow'],
    '3\nPgDn': ['Key_Numpad_3','Key_Numpad_PageDown'],
    'Enter__N': ['Key_Numpad_Enter'],
    'Ctrl__L': ['Key_LeftControl'],
    'Win__L': ['Key_LeftWin'],
    'Alt__L': ['Key_LeftAlt'],
    '': ['Key_Space'],
    'Alt__R': ['Key_RightAlt'],
    'Win__R': ['Key_RightWin'],
    'Menu': ['Key_Menu'],
    'Ctrl__R': ['Key_RightControl'],
    '←': ['Key_LeftArrow'],
    '↓': ['Key_DownArrow'],
    '→': ['Key_RightArrow'],
    '0\nIns': ['Key_Numpad_0','Key_Numpad_Insert'],
    '.\nDel': ['Key_Numpad_Period','Key_Numpad_Delete']
}